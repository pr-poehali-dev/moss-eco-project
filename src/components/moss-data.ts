...
export const T = {
  ru: {
    ...
    discount: {
      ...
      sub: "Скидки суммируются — выгода растёт вместе с заказом",
      tiers: [
        { label: "от 11 ед.", value: "10%", desc: "Скидка за объём заказа" },
        { label: "от 21 ед.", value: "15%", desc: "Скидка за объём заказа" },
        { label: "от 100 ед.", value: "20%", desc: "Скидка за объём заказа" },
        { label: "Первый заказ", value: "5%", desc: "При регистрации на сайте" },
      ],
    },
